            ...
            <Layout style={{ height: "100vh" }}>
                ...
                >
                    ...
                    <div className='side-nav'>
                        <a className='Sect' href='/'>home</a>
                        <a className='Sect' href='/'>About</a>
                        <a className='Sect' href='/'>Experience</a>
                        <a className='Sect' href='/'>Project</a>
                        <a className='Sect' href='/'>Contact</a>
